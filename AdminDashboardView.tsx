...
import type { User, Course, Order, AdminLog } from './types';
...
const AdminDashboardView: React.FC<{ users: User[]; courses: Course[]; orders: Order[]; adminLogs: AdminLog[]; onQuickAction: (view: AdminView) => void; }> = ({ users, courses, orders, adminLogs, onQuickAction }) => {
    ...
    return (
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <StatCard title="Total Courses" value={stats.totalCourses} change={stats.coursesChange} icon={<svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path d="M12 6.253v11.494m-9-5.747h18" /></svg>} />
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                 ...
                 <Card className="lg:col-span-1">
                      ...
                      <div className="grid grid-cols-2 gap-3">
                         ...
                         {/* FIX: Changed 'quizzes' to 'exams' to match AdminView type and "Add Quiz" to "Add Exam" for consistency. */}
