...
import { api } from './api';
import type { NewsPost, Media, YouTubeVideo } from './types';
...
const NewsPostEditor: React.FC<NewsPostEditorProps> = ({ post, onClose, onSave }) => {
    ...
    return (
        <>
            <Modal isOpen={true} onClose={onClose} title={post ? 'Edit Post' : 'Create New Post'} size="2xl">
